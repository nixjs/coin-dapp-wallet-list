...
export const Partner: (Dapp & { redirect: string })[] = [
  ...
  {
    name: "Swapuz",
    url: "https://swapuz.com/",
    redirect: "swapuz",
    description: `Swapuz is an anonymous service created for simple and fast cryptocurrency exchanges. We strive for maximum safety, simplicity, and convenience. We do not require any sort of account creation. Swapuz has more than 5000 coins available for exchange and does not hold any limits; you can exchange as much as you want - account-free, worry-free, faster than light.`,
